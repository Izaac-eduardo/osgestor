...
const toExportQuery = (filters: Filters): Omit<ConsumoFrotaFilters, 'page' | 'limit'> => ({ data_inicio: filters.data_inicio || undefined, data_fim: filters.data_fim || undefined, obra_id: filters.obra_id || undefined, frota_id: filters.frota_id || undefined, produto: filters.produto || undefined, tipo_calculo: filters.tipo_calculo, situacao: filters.situacao })
...
export function AbastecimentosConsumoFrotaPage() {
  ...
  return <>
    <PageHeader title="Média de Consumo por Frota" subtitle="Indicadores auditáveis de km/L e L/h por frota e produto." action={<AbastecimentosExportMenu kind="consumo-frota" filters={toExportQuery(applied)} />} />
