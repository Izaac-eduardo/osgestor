...
export const orderCategories=['LAVAGEM','MECANICA','AUTO_ELETRICA','ELETRICA','BORRACHARIA','LUBRIFICACAO','SOLDAGEM','FUNILARIA','HIDRAULICA','OUTROS'] as const
...
export interface OrderFilters{numero_os?:string;frota_codigo?:string;frota_numero?:string;obra_id?:string;prefixo_frota_id?:string;status?:OrderStatus|'';natureza_os?:OrderNature|'';categoria_servico?:OrderCategory|'';data_inicio?:string;data_fim?:string}
