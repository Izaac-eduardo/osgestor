...
import { AbastecimentosRelatoriosPage } from './pages/AbastecimentosRelatoriosPage'
import { AbastecimentosEntradasRelatorioPage } from './pages/AbastecimentosEntradasRelatorioPage'
import { AbastecimentosConsumoFrotaPage } from './pages/AbastecimentosConsumoFrotaPage'
...
export default function App() {
  return <Routes><Route element={<AppLayout />}><Route index element={<DashboardPage />} /><Route path="ordens-servico" element={<OrdensServicoPage />} /><Route path="obras" element={<ObrasPage />} /><Route path="funcionarios" element={<FuncionariosPage />} /><Route path="frotas" element={<FrotasPage />} /><Route path="relatorios" element={<RelatoriosPage />} /><Route path="importar-os" element={<ImportarOsPage />} /><Route path="abastecimentos/historico" element={<AbastecimentosHistoricoPage />} /><Route path="abastecimentos/relatorios" element={<AbastecimentosRelatoriosPage />} /><Route path="abastecimentos/relatorios/consumo-frota" element={<AbastecimentosConsumoFrotaPage />} /><Route path="abastecimentos/relatorios/entradas" element={<AbastecimentosEntradasRelatorioPage />} /><Route path="abastecimentos/entradas" element={<AbastecimentosEntradasPage />} /><Route path="abastecimentos/pontos" element={<AbastecimentosPontosPage />} /><Route path="abastecimentos/terceiros" element={<AbastecimentosTerceirosPage />} /><Route path="abastecimentos/destinacoes-especiais" element={<AbastecimentosEspeciaisPage />} /><Route path="abastecimentos/importar-polifrota" element={<AbastecimentosImportarPoliFrotaPage />} /><Route path="*" element={<NotFoundPage />} /></Route></Routes>
}
