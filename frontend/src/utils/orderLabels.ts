...
export const orderCategoryLabels: Record<OrderCategory, string> = { LAVAGEM: 'Lavagem', MECANICA: 'Mecânica', AUTO_ELETRICA: 'Auto elétrica', ELETRICA: 'Elétrica', BORRACHARIA: 'Borracharia', LUBRIFICACAO: 'Lubrificação', SOLDAGEM: 'Soldagem', FUNILARIA: 'Funilaria', HIDRAULICA: 'Hidráulica', OUTROS: 'Outros' }
