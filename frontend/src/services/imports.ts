...
export async function analyzeImport(file:File){const form=new FormData();form.append('arquivo',file);return (await api.post<ImportAnalysis>('/importacoes-os/analisar',form,{headers:{'Content-Type':'multipart/form-data'}})).data}
