import { api } from './api'
import type { AbastecimentoHistoricoFilters, AbastecimentoHistoricoResponse, AbastecimentosRelatorioResponse, AbastecimentoProduto, DestinacaoEspecial, Entrada, EntradaFilters, EntradaPayload, IdentificacaoTerceiro, PontoOperacional, Terceiro } from '../types/abastecimentos'
